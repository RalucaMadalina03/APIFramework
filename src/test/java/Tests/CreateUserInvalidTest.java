...
public class CreateUserInvalidTest {
    ...
    public void createUser(){  //PASUL 1 CREEAM USERUL CARE SA NE OFERE ID-UL
        ...
        username = "Madalina"; //+ System.currentTimeMillis()- scoatem partea aceasta pentru a determina daca ne da eroare ca rulam testul de 2 ori cu acelasi date
        password = "Madalina01!";

        RequestAcount requestAccount = new RequestAcount(username,password );
